...
def imageSegmentationGenerator( images_path , segs_path ,  batch_size,  n_classes , input_height , input_width , output_height , output_width   ):
	...
	while True:
		...
		for _ in range( batch_size) :
			im , seg = next(zipped)
			X.append( getImageArr(im , input_width , input_height, "sub_mean", "channels_last")  )
...
#G  = imageSegmentationGenerator( "data/dataset1/images_prepped_train/" ,  "data/dataset1/annotations_prepped_train/" ,  1,  10 , 224 , 224 , 224 , 224)
